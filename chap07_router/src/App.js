...
const A07Search = lazy(() => pMinDelay(import('./components/A07SearchParams'), 1000))
...
function App() {
  ...
  return (
    <div className="m-3">
      ...
      <NavLink className={getClass} to="/A07Search?id=1005&name=향단&address=전주#TOP">A07 1001</NavLink> | {' '}
      <NavLink className={getClass} to="/A07Search?id=1006&name=춘향&address=남원#MID">A07 1002</NavLink> | {' '}
      ...
      <Routes>
        ...
        {/* 
          패스를 이용한 값 전달 - 패스 역할을 하면서 지정한 이름이 변수가 된다 => 가장 많이 쓰는 방식 
          패스 to="/A06One/놀부/1001"라면 name="놀부", id="1001" 형태가 된다
